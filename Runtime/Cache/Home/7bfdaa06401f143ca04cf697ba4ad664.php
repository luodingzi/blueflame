...
<div class="container product">
    ...
    <p><?php echo ($products["intro"]); ?></p>
        <?php if($pre_products['id'] == '' ): ?><h4>上一篇：没有了</h4>
        <?php else: ?><h4>上一篇：<a href="/index.php?s=/home/index/product/id/<?php echo ($pre_products["id"]); ?>.html"><?php echo ($pre_products["title"]); ?></a></h4><?php endif; ?>

    <?php if($next_products['id'] == '' ): ?><h4>下一篇：没有了</h4>
        <?php else: ?><h4>下一篇：<a href="/index.php?s=/home/index/product/id/<?php echo ($next_products["id"]); ?>.html"><?php echo ($next_products["title"]); ?></a></h4><?php endif; ?>
    <h4><a  href="/index.php?s=/home/index/media.html">返回列表</a></h4>
</div>
<div class="container">
