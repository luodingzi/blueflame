...
<div class="container">
	...
	<div class="jumb">
	  <h3 style="text-align:center;margin-top:50px;"><?php echo ($news_data["title"]); ?></h3>
	  <h5 style="text-align:center"><?php echo ($news_data["createtime"]); ?>&nbsp;&nbsp;&nbsp;来源：蓝火文化</h5>
	  <p><?php echo ($news_data["content"]); ?></p>
	  
	</div>

	<?php if($pre_news['id'] == '' ): ?><h4>上一篇：没有了</h4>
	    <?php else: ?><h4>上一篇：<a href="/index.php?s=/home/index/news/id/<?php echo ($pre_news["id"]); ?>"><?php echo ($pre_news["title"]); ?></a></h4><?php endif; ?>


	<?php if($next_news['id'] == '' ): ?><h4>下一篇：没有了</h4>
	    <?php else: ?><h4>下一篇：<a href="/index.php?s=/home/index/news/id/<?php echo ($next_news["id"]); ?>"><?php echo ($next_news["title"]); ?></a></h4><?php endif; ?>
