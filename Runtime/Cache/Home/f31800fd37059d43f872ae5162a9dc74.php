...
<div class="navbar navbar-inverse navbar-fixed-top" role="navigation" id="menu-nav">
    ...
    <h3 class="txt">影视作品赏</h3>
    <div class="row">

        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="col-xs-6 col-md-3">
            <a href="/index.php?s=/home/index/product/id/<?php echo ($vo["id"]); ?>.html" class="thumbnail">
                <div class="mda"><img src="<?php echo (get_cover($vo["thumb"],'path')); ?>" style="height: 180px; width: 100%; display: block;" alt="<?php echo ($vo["title"]); ?>"></div>
            </a>
            <div class="caption">
                <h4><?php echo (msubstr(strip_tags($vo["title"]),0,15)); ?></h4>
            </div>  
