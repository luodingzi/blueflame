...
<div class="navbar navbar-inverse navbar-fixed-top" role="navigation" id="menu-nav">
    <div class="container">
        ...
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                ...
                <li><a href="/index.php?s=/home/index/content/id/2.html" >关于蓝火</a></li>
                <li><a href="/index.php?s=/home/index/example.html">蓝火案例</a></li>
                <li><a href="/index.php?s=/home/index/team.html">精英团队</a></li>
                <li><a href="/index.php?s=/home/index/join.html">加入我们</a></li>
    ...
    <h3 class="txt"><strong>欢迎加入蓝火大家庭！</strong></h3>
    <h4 class="txt">有意请发送相关个人资料至<a href="mailto:64115838@qq.com">64115838@qq.com</a></h4>
    <div class="row">



                     <div class="panel-group join" id="join">
                        <?php if(is_array($join)): $i = 0; $__LIST__ = $join;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$jo): $mod = ($i % 2 );++$i;?><div class="panel panel-info">
                                <div class="panel-heading">
                                    <h4 class="panel-title"><a data-toggle="collapse" data-parent="#join" href="#join<?php echo ($jo["id"]); ?>"><?php echo ($jo["title"]); ?></a></h4>
                                </div>
                                <div id="join<?php echo ($jo["id"]); ?>" class="panel-collapse collapse">
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form class="form-horizontal" action="/index.php?s=/home/index/message" method="post">
    ...
    <footer>
        <p style="text-align:center;color:#fff;"><a href="/index.php?s=/home/index/content/id/1.html">联系我们</a> | <a href="#" data-toggle="modal" data-target="#message">给我们留言</a> | <a href="http://www.miibeian.gov.cn/" target="_blank">粤ICP备12091022号</a> | Copyright &copy; 2014 <a href="index.php" >广州市蓝火文化传播有限公司</a> 版权所有</p>
    </footer>
