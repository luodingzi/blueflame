...
<div id="ad-carousel" class="carousel slide" data-ride="carousel" data-interval="3000">
    ...
    <div class="carousel-inner">
        <div class="item active">
           <img src="Public/Home/images/lunbo5.jpg" alt="阿拉善水活动">

        </div>
        <div class="item">
            <img src="Public/Home/images/lunbo2.jpg" alt="阿拉善水活动">

        </div>
        <div class="item">
            <img src="Public/Home/images/lunbo3.jpg" alt="阿拉善水活动">


        </div>
        <div class="item">
            <img src="Public/Home/images/lunbo4.jpg" alt="阿拉善水活动">


        </div>
        <div class="item">
            <img src="Public/Home/images/lunbo1.jpg" alt="阿拉善水活动">
...
<div class="container summary">
    ...
    <div class="row" id="summary-container">
        <div class="col-md-4 menu">
            <img class="mph" src="Public/Home/images/mp.jpg" alt="蓝火名片">
            <div class="overlay"><a href="/blueflame/index.php?s=/home/index/content/id/6.html"><img src="Public/Home/images/bg.png" alt="蓝火名片"><div class="menu-name">蓝火名片</div></a></div>
        </div>
        <div class="col-md-4 menu">
            <img class="mph" src="Public/Home/images/team.jpg" alt="精英团队">
            <div class="overlay"><a href="/blueflame/index.php?s=/home/index/team.html"><img src="Public/Home/images/bg.png" alt="精英团队"><div class="menu-name">精英团队</div></a></div>
        </div>
        <div class="col-md-4 menu">
             <img class="mph" src="Public/Home/images/study.jpg" alt="高端品牌研究中心">
             <div class="overlay"><a href="/blueflame/index.php?s=/home/index/content/id/3.html"><img src="Public/Home/images/bg.png" alt="高端品牌研究中心"><div class="menu-name">高端品牌研究中心</div></a></div>
        </div>
    </div>

    <div class="row" id="summary-container">
        <div class="col-md-4 menu">
            <img class="mph" src="Public/Home/images/case.jpg" alt="蓝火案例">
            <div class="overlay"><a href="/blueflame/index.php?s=/home/index/example.html"><img src="Public/Home/images/bg.png" alt="蓝火案例"><div class="menu-name">蓝火案例</div></a></div>
        </div>
        <div class="col-md-4 menu">
            <img class="mph" src="Public/Home/images/partner.jpg" alt="品牌战略合作伙伴">
            <div class="overlay"><a href="/blueflame/index.php?s=/home/index/partner.html"><img src="Public/Home/images/bg.png" alt="品牌战略合作伙伴"><div class="menu-name">品牌战略合作伙伴</div></a></div>
        </div>
        <div class="col-md-4 menu">
             <img class="mph" src="Public/Home/images/media.jpg" alt="多元化媒体运作">
             <div class="overlay"><a href="/blueflame/index.php?s=/home/index/content/id/4.html"><img src="Public/Home/images/bg.png" alt="多元化媒体运作"><div class="menu-name">多元化媒体运作</div></a></div>
        </div>     
    </div>

    <div class="row" id="summary-container">
        <div class="col-md-4 menu">
            <img class="mph" src="Public/Home/images/tvc.jpg" alt="影视作品赏">
            <div class="overlay"><a href="/blueflame/index.php?s=/home/index/media.html"><img src="Public/Home/images/bg.png" alt="影视作品赏"><div class="menu-name">影视作品赏</div></a></div>
        </div>
        <div class="col-md-4 menu">
            <img class="mph" src="Public/Home/images/news.jpg" alt="新闻热报">
            <div class="overlay"><a href="/blueflame/index.php?s=/home/index/press.html"><img src="Public/Home/images/bg.png" alt="新闻热报"><div class="menu-name">新闻热报</div></a></div>
        </div>
        <div class="col-md-4 menu">
             <img class="mph" src="Public/Home/images/bwf.jpg" alt="微电影中国">
             <div class="overlay"><a href="/blueflame/index.php?s=/home/index/wei.html"><img src="Public/Home/images/bg.png" alt="微电影中国"><div class="menu-name">微电影中国</div></a></div>
        </div>
    </div>
</div>
